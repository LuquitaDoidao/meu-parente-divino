...
document.getElementById('botaoEnviar').addEventListener('click', function(event) {
    ...
    el.classList.add(`fundo_${deusFinal}`);

    let eu = document.getElementById('retalho');
    eu.classList.remove('fundao_colorido');
    eu.classList.add(`fundao_${deusFinal}`);
});
